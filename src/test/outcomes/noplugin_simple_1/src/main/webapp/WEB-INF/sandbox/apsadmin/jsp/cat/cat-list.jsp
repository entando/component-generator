...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<s:text name="title.catManagement" />
	</span>
</h1>
...
<s:form action="search">
			...
			<td class="text-center text-nowrap">
				...
				<div class="btn-group btn-group-xs">
					<a
						...
						title="<s:text name="cat.label.delete" />: <s:property value="#cat_var.id" />"
						class="btn btn-warning"
						>
						<span class="icon fa fa-times-circle-o"></span>&#32;
						<span class="sr-only"><s:text name="cat.label.delete" /></span>
					</a>
				</div>
			</td>
	...
	<s:else>
		<div class="alert alert-info margin-base-vertical">
			<s:text name="cat.message.list.empty" />
		</div>
	</s:else>
</s:form>