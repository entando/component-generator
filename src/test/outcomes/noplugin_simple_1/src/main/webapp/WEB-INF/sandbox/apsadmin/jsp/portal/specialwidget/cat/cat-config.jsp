...
<s:form action="saveConfig" namespace="/do/sandbox/Cat/Page/SpecialWidget/sandboxCatConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select cssClass="form-control" list="catsId" name="id" id="id" cssClass="form-control" />
