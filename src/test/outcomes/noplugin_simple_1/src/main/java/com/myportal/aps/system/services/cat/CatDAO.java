...
public class CatDAO extends AbstractSearcherDAO implements ICatDAO {
	...
	private static final String ADD_CAT = "INSERT INTO cat (id, name, age, weight, createdat ) VALUES (?, ?, ?, ?, ? )";

	private static final String UPDATE_CAT = "UPDATE cat SET  name=?,  age=?,  weight=?, createdat=? WHERE id = ?";

	private static final String DELETE_CAT = "DELETE FROM cat WHERE id = ?";
	
	private static final String LOAD_CAT = "SELECT id, name, age, weight, createdat  FROM cat WHERE id = ?";
	
	private static final String LOAD_CATS_ID  = "SELECT id FROM cat";
