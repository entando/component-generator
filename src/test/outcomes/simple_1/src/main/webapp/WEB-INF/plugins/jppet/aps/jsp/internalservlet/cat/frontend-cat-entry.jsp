...
<s:if test="strutsAction==1">
	<h1><wp:i18n key="jppet_CAT_NEW" /></h1>
</s:if>
<s:elseif test="strutsAction==2">
	<h1><wp:i18n key="jppet_CAT_EDIT" /></h1>
</s:elseif>

<form action="<wp:action path="/ExtStr2/do/FrontEnd/jppet/Cat/save.action" />" method="post">
	...
	<fieldset>
		...
		<label for="cat_createdat_cal"><wp:i18n key="jppet_CAT_CREATEDAT" /></label>
