...
<h1><wp:i18n key="jppet_CAT_SEARCH_CAT" /></h1>

<form action="<wp:action path="/ExtStr2/do/FrontEnd/jppet/Cat/search.action" />" method="post" >

  <fieldset>
		<label for="cat_id"><wp:i18n key="jppet_CAT_ID" /></label>
		<input type="text" name="id" id="cat_id" value="<s:property value="id" />" />
		<label for="cat_name"><wp:i18n key="jppet_CAT_NAME" /></label>
		<input type="text" name="name" id="cat_name" value="<s:property value="name" />" />
		<label for="cat_age"><wp:i18n key="jppet_CAT_AGE" /></label>
		<input type="text" name="age" id="cat_age" value="<s:property value="age" />" />
		<label for="cat_weight"><wp:i18n key="jppet_CAT_WEIGHT" /></label>
		<input type="text" name="weight" id="cat_weight" value="<s:property value="weight" />" />
		<label for="cat_createdatStart_cal"><wp:i18n key="jppet_CAT_CREATEDATSTART" /></label>
		<input type="text" name="createdatStart" id="cat_createdatStart_cal" data-isdate="true" value="<s:property value="createdatStart" />" />
		<label for="cat_createdatEnd_cal"><wp:i18n key="jppet_CAT_CREATEDATEND" /></label>
...
<p>
  <a href="<wp:action path="/ExtStr2/do/FrontEnd/jppet/Cat/new.action"></wp:action>" title="<wp:i18n key="NEW" />" class="btn btn-info">
...
<tr>
  <th class="text-right">
    <wp:i18n key="jppet_CAT_ID" />
  </th>
	<th
                 class="text-left"><wp:i18n key="jppet_CAT_NAME" /></th>
	<th
         class="text-right"        ><wp:i18n key="jppet_CAT_AGE" /></th>
	<th
             class="text-right"    ><wp:i18n key="jppet_CAT_WEIGHT" /></th>
	<th
     class="text-center"            ><wp:i18n key="jppet_CAT_CREATEDAT" /></th>
	<th>
    <wp:i18n key="jppet_CAT_ACTIONS" />
  </th>
</tr>
</thead>
<tbody>
...
<tr>
	...
	<td class="text-right">
    <a
      href="<wp:action path="/ExtStr2/do/FrontEnd/jppet/Cat/edit.action"><wp:parameter name="id"><s:property value="#cat.id" /></wp:parameter></wp:action>"
    ...
    <a
      href="<wp:action path="/ExtStr2/do/FrontEnd/jppet/Cat/trash.action"><wp:parameter name="id"><s:property value="#cat.id" /></wp:parameter></wp:action>"
